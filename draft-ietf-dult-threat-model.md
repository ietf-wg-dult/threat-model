...
It is also appropriate to define who is using the tracking tags and incorporate this into a model. This is because if protocols overly deprioritize the privacy of tracking tags’ users, an attacker could use a victim’s own tag to track them. In addition, in some parts of the world, human rights defenders working against domestic and sexual violence, or for the rights of women and sexual/gender minorities, face severe state repression and surveillance. It is important to consider potential risks to these and other non-malicious tag users. Beck et al. describe one [possible technological solution](https://eprint.iacr.org/2023/1332.pdf) to the problem of user privacy vs privacy of other potential victims. More recently, Con has attempted to expand on this work [(Con, 2024)](https://arxiv.org/pdf/2412.17003). In designing the protocol, these considerations should be weighed through a process that: 1) reviews recent developments in fully-anonymous secret sharing, and 2) consults with multinational experts in both stalking/partner violence, and in privacy and human rights. The [IRTF Human Rights Protocol Considerations Research Group](https://www.irtf.org/hrpc.html) may be a resource.
